...
//    try {
//      final ByteData imgData = await rootBundle.load('lib/assets/map/my_picto.png');
...
//      final BitmapDescriptor customMarker = BitmapDescriptor.fromBytes(resizedBytes);

//      return Marker(
//        markerId: MarkerId("photo_${photo.photoId}"),
//        position: LatLng(photo.lat!, photo.lng!),
//        icon: customMarker,
//        onTap: () => onTap(photo),
//        infoWindow: InfoWindow(
//          title: photo.location ?? '위치 정보 없음',
//          snippet: "좋아요: ${photo.likes} • 조회수: ${photo.views}",
//        ),
//      );
//    } catch (e) {
